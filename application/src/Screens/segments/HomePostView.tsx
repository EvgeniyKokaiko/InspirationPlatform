    ...
    return (
      <View style={[MP.mb20]}>
        ...
        <LikeButton owner={props.entity.owner} postHash={props.entity.image} />
          <TouchableOpacity onPress={() => props.onCommendPress(props.entity.image as string)} style={[{ width: mockupWidthToDP(40), height: mockupHeightToDP(30) }, StylesOne.flex_row, StylesOne.flex_ai_c, MP.mr20]}>
